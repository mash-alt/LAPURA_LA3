    ...
    public partial class ArraysForm : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(word))
            {
                ...
                {
                    MessageBox.Show("Numbers are not allowed in the words array.", "Invalid Input", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
        ...
        private void Calculate_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No numbers in array to calculate.", "Empty Array", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
    }
}